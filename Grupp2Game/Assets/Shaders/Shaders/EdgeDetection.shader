...
//Edge detection by a random guy on internet
//This is a Unlit shader, which means it doesn't react to light
//About lit vs unlit https://www.reddit.com/r/Unity3D/comments/1cx509j/general_advice_on_lit_vs_unlit_performance_help/?rdt=53181
//Or this:
//"Lit means that it uses the actual lights (directional world lighting, spotlights, radial lights and so on) in the scene. 
//while Unlit does not, and shows only the true colours of the graphic regardless of lighting conditions." - Random internet guy
